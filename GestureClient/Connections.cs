...
namespace GestureClient
{
    ...
    class Connections
    {
        ...
        private const int d_port = 11225;
        ...
        public string SendDiscovery()
        {
            var PhoneName = Microsoft.Phone.Info.DeviceStatus.DeviceName;
            string data = PhoneName +":" + d_port.ToString();
            ...
            if (_socket != null)
            {
                ...
                socketEventArg.RemoteEndPoint = new DnsEndPoint(IPAddress.Broadcast.ToString(), d_port);
        ...
        public string Receive()
        {
            ...
            if (_socket != null)
            {
                // Create SocketAsyncEventArgs context object
                SocketAsyncEventArgs socketEventArg = new SocketAsyncEventArgs();
                socketEventArg.RemoteEndPoint = new IPEndPoint(IPAddress.Any, d_port);
